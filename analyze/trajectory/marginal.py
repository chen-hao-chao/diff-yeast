...
def align_frames(green_frames, red_frames):
    """Align all frames so the red channel intersection is centered.
    ...
    # First pass: find red centers for all frames
    centers = []
    prev_center = None
    for red_img in red_frames:
        center = _find_red_center(red_img, prev_center)
        centers.append(center)
        prev_center = center

    # Second pass: shift both channels to align red center to image center
    aligned_green = []
    aligned_red = []
